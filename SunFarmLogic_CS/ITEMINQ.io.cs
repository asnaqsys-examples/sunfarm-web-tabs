...
namespace ACME.SunFarm
{
    ...
    public partial class ITEMINQ
    {
        ...
        static (ILayout layout, int position) ITEMDS_000 = (Layout.Packed(9, 0), 0);
        static (ILayout layout, int position) ITEMDS_001 = (Layout.FixedString(50), 5);
        static (ILayout layout, int position) ITEMDS_002 = (Layout.FixedString(20), 55);
        static (ILayout layout, int position) ITEMDS_003 = (Layout.Zoned(5, 0), 75);
        static (ILayout layout, int position) ITEMDS_004 = (Layout.Packed(9, 4), 80);
        static (ILayout layout, int position) ITEMDS_005 = (Layout.Packed(7, 4), 85);
        static (ILayout layout, int position) ITEMDS_006 = (Layout.FixedString(10), 89);
        static (ILayout layout, int position) ITEMDS_007 = (Layout.Packed(12, 4), 99);
        static (ILayout layout, int position) ITEMDS_008 = (Layout.Packed(12, 4), 106);
        const int extSizeITEMDS = 113;
        private static Dictionary<string, string> ITEMMASTL2FormatIDs = new Dictionary<string, string>()
        {
            { "RITEMMASTL2", "MYptlBMMlFkTrB+iC4clV88B0MA=" }
        };
        private static Dictionary<string, string> ITEMMASTL1FormatIDs = new Dictionary<string, string>()
        {
            { "RITEMMASTL1", "MYptlBMMlFkTrB+iC4clV88B0MA=" }
        };
        private static Dictionary<string, string> ITEMMASTL1_ReadOnlyFormatIDs = new Dictionary<string, string>()
        {
            { "RITEMMASTL1", "MYptlBMMlFkTrB+iC4clV88B0MA=" }
        };
        ...
        private FixedString<_50> ITEMDESC
        {
            ...
            set
            {
                this.ITEMDS.SetString(value, 5, 50);
            }
        }
        private FixedString<_20> ITEMSHRTDS
        {
            ...
            set
            {
                this.ITEMDS.SetString(value, 55, 20);
            }
        }
        ...
        private FixedString<_10> ITEMUNIT
        {
            ...
            set
            {
                this.ITEMDS.SetString(value, 89, 10);
            }
        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while writing file ITEMDSPF.");
                                }
                            }
                        }
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while reading file ITEMDSPF.");
                                }
                            }
                        }
                    }
        ...
        private void PopulateBufferITEMMASTL1_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.GetAdgTable("*FILE");
            System.Data.DataRow _row = _table.Row;
            _row["ITEMNUMBER"] = ((decimal)(ITEMNUMBER));
        ...
        private void PopulateFieldsITEMMASTL1_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.SetActive("*FILE");
            System.Data.DataRow _row = _table.Row;
            ITEMNUMBER = ((decimal)(_row["ITEMNUMBER"]));
