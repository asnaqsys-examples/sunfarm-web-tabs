...
namespace ACME.SunFarm
{
    ...
    public partial class ORDDTLINQ
    {
        ...
        {
            { "RORDERLINL2", "ZgLaFmi11VaM21ivXYmcwM/P/Bo=" }
        };
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while writing file ORDDTLINQD.");
                                    }
                                }
                            }
                        }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while reading file ORDDTLINQD.");
                                    }
                                }
                            }
                        }
