...
namespace ACME.SunFarm
{
    ...
    public partial class CUSTINQ
    {
        ...
        private byte aSFNAME;
        private byte aCONTACT;
        private byte aFAXPHONE;
        private FixedString<_10> SCPGM;
        private FixedString<_40> SFOLDNAME;
        private FixedString<_40> hSFNAME;
        ...
        private FixedString<_1> hsSTATUS;
        ...
        {
            { "RCUSTOMERL2", "6su4S42+ard0ZHitdjHOFT1WPw0=" }
        };
        ...
        private static Dictionary<string, string> CUSTOMERL1_ReadOnlyFormatIDs = new Dictionary<string, string>()
        {
            { "RCUSTOMERL1", "6su4S42+ard0ZHitdjHOFT1WPw0=" }
        };
        ...
        private void PopulateBufferCUSTDSPFCUSTREC(AdgDataSet _dataSet)
        {
            ...
            _row["@SFNAME"] = ((byte)(aSFNAME));
            _row["@CONTACT"] = ((byte)(aCONTACT));
            _row["@FAXPHONE"] = ((byte)(aFAXPHONE));
            _row["SCPGM"] = ((string)(SCPGM));
            _row["SFCUSTNO"] = ((decimal)(SFCUSTNO));
            _row["SFOLDNAME"] = ((string)(SFOLDNAME));
            _row["#SFNAME"] = ((string)(hSFNAME));
        ...
        private void PopulateBufferCUSTOMERL1_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.GetAdgTable("*FILE");
            System.Data.DataRow _row = _table.Row;
            _row["CMCUSTNO"] = ((decimal)(CMCUSTNO));
        ...
        private void PopulateFieldsCUSTOMERL1_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.SetActive("*FILE");
            System.Data.DataRow _row = _table.Row;
            CMCUSTNO = ((decimal)(_row["CMCUSTNO"]));
