...
namespace ACME.SunFarm
{
    ...
    public partial class CUSTPRMPT
    {
        ...
        {
            { "RSHIPPING", "Q6zxbCCsNWjkgTEOfwEN+1R7BGw=" }
        };
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while writing file CUSTPRMP.");
                        }
                    }
                }
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while reading file CUSTPRMP.");
                        }
                    }
                }
            }
