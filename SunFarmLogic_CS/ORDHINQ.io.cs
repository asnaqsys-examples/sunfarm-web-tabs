...
namespace ACME.SunFarm
{
    ...
    public partial class ORDHINQ
    {
        ...
        static (ILayout layout, int position) OrdhDS_000 = (Layout.Packed(9, 0), 0);
        static (ILayout layout, int position) OrdhDS_001 = (Layout.Packed(9, 0), 5);
        static (ILayout layout, int position) OrdhDS_002 = (Layout.Date(DateTimeFormat.ISO, DateTimeSeparator.Default), 10);
        static (ILayout layout, int position) OrdhDS_003 = (Layout.Date(DateTimeFormat.ISO, DateTimeSeparator.Default), 20);
        static (ILayout layout, int position) OrdhDS_004 = (Layout.Packed(8, 0), 30);
        static (ILayout layout, int position) OrdhDS_005 = (Layout.Zoned(3, 0), 35);
        static (ILayout layout, int position) OrdhDS_006 = (Layout.Packed(13, 4), 38);
        static (ILayout layout, int position) OrdhDS_007 = (Layout.Packed(13, 4), 45);
        static (ILayout layout, int position) OrdhDS_008 = (Layout.Packed(9, 2), 52);
        const int extSizeOrdhDS = 57;
        private static Dictionary<string, string> OrderHdrL2FormatIDs = new Dictionary<string, string>()
        {
            { "RORDERHDRL2", "HGKtY5i8LuqjN1v8eIQidC7WD6Q=" }
        };
        private static Dictionary<string, string> OrderHdrL1FormatIDs = new Dictionary<string, string>()
        {
            { "ROrderHdrL1", "HGKtY5i8LuqjN1v8eIQidC7WD6Q=" }
        };
        private static Dictionary<string, string> OrderHdrL1_ReadOnlyFormatIDs = new Dictionary<string, string>()
        {
            { "ROrderHdrL1", "HGKtY5i8LuqjN1v8eIQidC7WD6Q=" }
        };
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while writing file ORDHDSPF.");
                                    }
                                }
                            }
                        }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        throw new System.InvalidOperationException($"Invalid record format {_recordFormatName} while reading file ORDHDSPF.");
                                    }
                                }
                            }
                        }
        ...
        private void PopulateBufferOrderHdrL1_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.GetAdgTable("*FILE");
            System.Data.DataRow _row = _table.Row;
            _row["ORDNUM"] = ((decimal)(ORDNUM));
        ...
        private void PopulateFieldsOrderHdrL1_ReadOnly(string _, AdgDataSet _dataSet)
        {
            var _table = _dataSet.SetActive("*FILE");
            System.Data.DataRow _row = _table.Row;
            ORDNUM = ((decimal)(_row["ORDNUM"]));
