...
{
    [ActivationGroup("*DFTACTGRP"), System.ComponentModel.Description("Prompt List for State and Status Codes")]
    [ProgramEntry("_ENTRY")]
    public partial class CUSTPRMPT : Program
    {
        ...
        FixedString<_32> WorkDS { get => _DS2.GetString(0, 32); set => _DS2.SetString((string)value, 0, 32); } 
        FixedString<_2> wkAbbrev { get => _DS2.GetString(0, 2); set => _DS2.SetString((string)value, 0, 2); } 
        FixedString<_30> wkDesc { get => _DS2.GetString(2, 30); set => _DS2.SetString((string)value, 2, 30); } 
        FixedString<_1> wkAbbrev2 { get => _DS2.GetString(0, 1); set => _DS2.SetString((string)value, 0, 1); } 
        FixedString<_31> wkDesc2 { get => _DS2.GetString(1, 31); set => _DS2.SetString((string)value, 1, 31); } 
...
#region Entry and activation methods for *ENTRY
        ...
        void _instanceInit()
        {
            ...
            X = 0m;
            CUSTPRMP = new WorkstationFile(PopulateBufferCUSTPRMP, PopulateFieldsCUSTPRMP, null, "CUSTPRMP", "/SunFarmViews/CUSTPRMP");
            CUSTPRMP.Open();
